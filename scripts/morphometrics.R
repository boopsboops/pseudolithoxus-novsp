...
# load raw data
tab1 <- read.table("../analyses/morphometrics_raw.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE, row.names="Measurement")
...
# print the table
kable(fintab, format = "markdown")

# save
# write.table(fintab, file = "../analyses/measurements.csv", quote=FALSE, sep=",", row.names=FALSE, col.names=TRUE)
