...
\hypersetup{breaklinks=true,bookmarks=true,colorlinks=true,urlcolor=blue,linkcolor=green,citecolor=red,pdfauthor={Rupert A.\ Collins},pdftitle={Biogeography and species delimitation of the rheophilic suckermouth-catfish genus Pseudolithoxus (Siluriformes: Loricariidae), with the description of a new species from the Brazilian Amazon}}
...
These highly disjunct records are now placed in an evolutionary and phylogeographic context using a dated species tree constructed from mitochondrial (Cytb) and nuclear (RAG1) gene sequence data. %
...
We also thank José Luis Birindelli for the invitation to participate in the rio Pitinga Expedition (2014), funded by CNPq Proc.\ CNPq n\degree 478900/2013-9. %
